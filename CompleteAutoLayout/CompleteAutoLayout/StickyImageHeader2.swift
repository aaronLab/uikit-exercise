...
class StickyImageHeader2: UIViewController, UIScrollViewDelegate {
    ...
    func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        if y > 0 {
            var scale = 1.0 + abs(scrollView.contentOffset.y / 500)
            scale = max(0.0, scale)
